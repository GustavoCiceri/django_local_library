...
class BookListView(generic.ListView):
    model = Book#consulta o banco de dados e obtem todos os registros do modelo especificado
    #atributos para alterar o comportamento padrao acima
...
class BibliotecarioListView(PermissionRequiredMixin, generic.ListView):
    model = BookInstance
    template_name = 'catalog/bibliotecario.html'
...
class AuthorCreate(PermissionRequiredMixin, CreateView):
    ...
    initial = {'date_of_death': '11/11/2026'}
