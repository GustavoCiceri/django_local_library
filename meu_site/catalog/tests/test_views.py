...
class RenewBookInstancesViewTest(TestCase):
    def setUp(self):
        ...
        test_book.genre.set(genre_objects_for_book)
        test_book.save()
        return_date = datetime.date.today() + datetime.deltatime(days=5)
    ...
    def test_form_invalid_renewal_date_past(self):
        ...
        response = self.client.post(reverse('renewal-book-librarian', kwargs={'pk': self.test_bookinstance1.pk}), {'renewal_date': date_in_past})
        self.assertEqual(response.status_code, 200)
